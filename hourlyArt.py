"""
    The python file does all the external stuff.
    It gets a random image, downloads it, kicks off the processing sketch,
    then takes the new image (and gif) and uploads them to the tumblr site.
"""
